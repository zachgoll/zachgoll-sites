...
![save button](https://media.zachgollwitzer.com/btn-using-js.jpg)

Here is what this button would look like _without_ CSS and _without_ JavaScript.

![button without styling](https://media.zachgollwitzer.com/btn-wo-style.jpg)

And here is what this button would look like _with_ CSS, but _without_ JavaScript.

![button with styling](https://media.zachgollwitzer.com/btn-with-style.jpg)
